...
\lstset{language=Python,                        % Use MATLAB
        frame=none,                           % Single frame around code
        basicstyle=\tiny\ttfamily,             % Use small true type font
        keywordstyle=[1]\usefont{T1}{pcr}{m}{sl}\color{Blue}\bf,        % MATLAB functions bold and blue
        keywordstyle=[2]\usefont{T1}{pcr}{m}{sl}\color{Purple},         % MATLAB function arguments purple
        keywordstyle=[3]\usefont{T1}{pcr}{m}{sl}\color{Blue}\underbar,  % User functions underlined and blue
        identifierstyle=,                       % Nothing special about identifiers
                                                % Comments small dark green courier
        commentstyle=\usefont{T1}{pcr}{m}{sl}\color{Green}\tiny,
