...
def plot(n_runs):
    ...
    #plt.show()
    plt.savefig('learning_curves_{0}.png'.format(n_runs))
    plt.savefig('learning_curves_{0}.pdf'.format(n_runs), pad_inches=0.05, bbox_inches='tight')

if __name__ == '__main__':
    for n_runs in [1,2,3,4]:
        results = run(n_runs)
