...
\usepackage[accepted]{icml2015stylefiles/arxiv} 
...
\citet{larsen1998adaptive}, \citet{eigenmann1999gradient}, \citet{chen1999optimal}, \citet{bengio2000gradient}, and \citet{abdel2007adaptive} used a shortcut to compute gradients of the validation loss, but only with respect to regularization parameters that contribute linearly to that loss.
\citet{bengio2000gradient} and \citet{foo2008efficient} additionally showed that more general gradients are available in closed form when training has converged exactly to a local minimum.
