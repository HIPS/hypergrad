...
sensible and reversible set of dynamics that does not converge.
...
automatically. Since we require access to the internal logic of RMD we implemented
our own automatic differentiation for Python
(link to source code will be made available upon publication).
