...
There is no hope then, of exactly reversing optimizing dynamics without storing
some extra bits. But we can try to be parsimonious about the number of extra
bits we store. This is what the next section tries to achieve.
