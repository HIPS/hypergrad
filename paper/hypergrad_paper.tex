...
We experimented with using several standard stochastic optimization methods for meta-optimization, including plain SGD, RMSprop~\citep{Tieleman2012}, and minibatch conjugate gradients.
...
SGD has many popular variants, such as RMSprop~\cite{Tieleman2012}.
